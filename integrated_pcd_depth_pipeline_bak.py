...
# =============================================================================
# Default Configuration - v3 (X > 0 = forward, synchronized_data_pangyo_optimized)
# =============================================================================
DEFAULT_CALIB = {
    "a6": {
        "model": "vadas",
...
def run_integrated_pipeline(
    ...
    print(f"=== Integrated PCD-to-Depth Pipeline v3 (Closest-Line Mode) ===")
    print(f"[COORD] v3 coordinate system (X > 0 = forward, synchronized_data_pangyo_optimized)")
